(() => {
  ...
  // ns-hugo:/home/runner/work/ErichGB.github.io/ErichGB.github.io/assets/js/theme-toggle.js
  ...
  // ns-hugo:/home/runner/work/ErichGB.github.io/ErichGB.github.io/assets/js/qr-generator.js
  ...
  var QRGenerator = class {
    ...
    updateCharCounter() {
      ...
      if (this.charCounter.remaining) {
        if (remaining >= 0) {
          ...
          this.charCounter.remaining.textContent = `${Math.abs(remaining)} sobre el l\xEDmite`;
        }
      }
    ...
    async generateQR() {
      ...
      try {
        ...
        const qrCodeDataURL = await import_qrcode.default.toDataURL(qrContent, {
          width: 200,
          margin: 2,
          color: {
            dark: "#000000",
        ...
        alert("Error al generar el c\xF3digo QR. Por favor, int\xE9ntalo de nuevo.");
      } finally {
    ...
    downloadQR() {
      ...
      try {
        ...
        alert("Error al descargar el c\xF3digo QR.");
      }
    }
  };

  // <stdin>
  var MobileLanterApp = class {
    constructor() {
